...
| POST | `/partners/webhook-url` | Set the URL that receives [Balance Change Webhook](/guides/partner-prefunding/balance-change-webhook) events |

## Balance Change Webhook

To get notified whenever your prefund balance changes (deposit, withdraw, or compensation), configure a partner-level webhook URL. See [Balance Change Webhook](/guides/partner-prefunding/balance-change-webhook) for the event headers, payload, and `change_type` values.
