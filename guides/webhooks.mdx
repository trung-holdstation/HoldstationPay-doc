...
| `pay.partner.fund-balance-changed`  | Partner-level webhook                         | Triggered when a partner fund balance changes. See [Balance Change Webhook](/guides/partner-prefunding#balance-change-webhook). |
